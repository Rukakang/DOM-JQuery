...
//jquery代码
//第一版
var api = jQuery_before('.test'); //不返回元素们，返回api

api.addClass('red') //this就是api
.addClass('blue').addClass('grey'); //链式操作
//第二版（优化后）

jQuery_before1('.test2').addClass('red').addClass('blue').addClass('grey'); //第三版，完善函数功能

/*const x1 = jQuery('.test3');
console.log(x1);

const x2 = jQuery('.test3').find('.child');
console.log(x2);

const x3 = jQuery('.test3')
            .find('.child')
            .addClass('ss');
console.log(x3);

const x4 = jQuery('.test3') //api1,并赋值api1给oldapi
.find('.child')  //api1赋值给数组的oldapi对象，并再次调用jquery,返回api2
...
/*const x5 = jQuery('.test3')
           .find('.child')
           .addClass('red')
           .each((div)=>{console.log(div)});*/

/*
const x6 =jQuery('.test3')
          .parent()
          .end()
          .addClass('white'); */
//const x7 =jQuery('.test3');
//x7.children().addClass('end').end().addClass('bbend');

jQuery8('#test3').find('.child').addClass('red'); // 请确保这句话成功执行
